...
const faqs = [
  ...
  },
  {
    ...
    answer: 'We are currently working on a native mobile app for iOS and Android. You can access your medical history and share records with doctors from anywhere, anytime.',
  },
];
