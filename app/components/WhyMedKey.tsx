      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-[#f4f7fb] rounded-2xl p-8 border border-[#d9e4f2]"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-[#e6fbf9] rounded-2xl p-8 border border-[#bce9e6]"
          >
            <div className="flex items-center gap-3 mb-6">
            ...
            <ul className="space-y-4 mb-6">
              {solutions.map((solution, index) => (
                <motion.li
                  ...
                  className="flex items-start gap-3 text-gray-700"
                >
                  <CheckCircle2 className="w-5 h-5 text-[#0fb5ba] mt-0.5 flex-shrink-0" />
                  <span>{solution}</span>
                </motion.li>
              ))}
            </ul>
            ...
            >
              <a
                href="#cta"
                className="inline-flex items-center gap-2 bg-[#0f2f6b] text-white px-6 py-3 rounded-full font-semibold hover:bg-[#123b88] transition-colors"
              >
                Get Started
        ...
        >
          <div className="bg-gradient-to-r from-[#0f2f6b] to-[#123b88] rounded-2xl p-8 md:p-12 text-white">
